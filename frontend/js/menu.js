    ...
    if (!ajaxLoading) {
      ...
      $.ajax({
        ...
        obj.forEach( function(speech) {
           $(target).append("<div class='row'><div class='large-8 columns'><p>"+speech.start+" : "+speech.title+"</div><div class='large-4 columns'><a href='#' class='button openmodal' data-reveal-id='infos"+speech.number+"-"+target.slice(1,target.length)+"'> weitere Informationen</a> <a href='participate.php' class='button'> Teilnehmen </a></p></div></div>");
